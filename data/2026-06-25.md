...
### [2] [Minimax PAC Bounds for Learning in Exogenous Contextual MDPs](https://arxiv.org/abs/2606.25170)
...
### [3] [Stabilizing black-box algorithms through task-oriented randomization](https://arxiv.org/abs/2606.25269)
...
### [4] [Statistically Valid Hyperparameter Selection: From Tuning to Guarantees](https://arxiv.org/abs/2606.25601)
...
### [5] [Gaussian Mean Field Variational Inference can Overestimate Predictive Variance](https://arxiv.org/abs/2606.25745)
...
### [6] [FedReLa: Imbalanced Federated Learning via Re-Labeling](https://arxiv.org/abs/2606.26037)
...
### [7] [When Does Synthetic Data Augmentation Improve Score-Based Imbalanced Classification?](https://arxiv.org/abs/2606.26053)
...
### [8] [An iterative energy-based multimodal transformer for joint retrieval of wheat soil moisture, leaf area index, and plant height from Sentinel-1 and Sentinel-2 time series](https://arxiv.org/abs/2606.25174)
...
### [9] [A Single Stepsize Suffices for Unprojected Linear TD(0): Simultaneous Robust and Fast Rates via Polyak--Ruppert Averaging](https://arxiv.org/abs/2606.24981)
...
### [10] [Latent Block-Diffusion Temporal Point Processes: A Semi-Autoregressive Framework for Asynchronous Event Sequence Generation](https://arxiv.org/abs/2606.24982)
...
### [12] [Supervised Reinforcement Learning for the Coordination of Distributed Energy Resources](https://arxiv.org/abs/2606.24947)
...
### [14] [A Leakage-Aware Comparative Benchmark of Machine Learning, Deep Learning, and Transformer Models for Reliable Leukemia Detection](https://arxiv.org/abs/2606.24944)
*Nisreen Albzour*
...
### [15] [Benchmarking the Alignment of Data-Quality Metrics, Human Judgment and Land-Cover Segmentation Performance for Earth Observation](https://arxiv.org/abs/2606.25128)
...
### [16] [Dimension expansion for simulation-efficient nanophotonic neural networks](https://arxiv.org/abs/2606.25226)
...
### [17] [Dual Agreement Consistency Learning for Semi-Supervised Fetal Ultrasound Segmentation](https://arxiv.org/abs/2606.25254)
...
### [18] [Blasto-Net: An Explainable Multi-Task Learning for Blastocyst Segmentation, Grading, and Implantation Prediction](https://arxiv.org/abs/2606.25463)
...
### [19] [Cross-Attention Multimodal Learning for Predicting Response to Neoadjuvant Imatinib in Gastrointestinal Stromal Tumors: A Multicenter Retrospective Study](https://arxiv.org/abs/2606.25579)
...
### [20] [Improving Richardson--Lucy Deconvolution with Diffusion Priors for Fluorescence Microscopy](https://arxiv.org/abs/2606.25924)
...
### [21] [Reconstruction of chaotic systems in invariant jet space](https://arxiv.org/abs/2606.24929)
*Evgeny Nikulchev*
...
### [22] [Solving Markov Decision Processes with Future Information via MPC](https://arxiv.org/abs/2606.24991)
...
### [23] [Toward Next-Generation AI Data Centers: Power Delivery Architecture Shifts, Emerging Technologies, and Challenges](https://arxiv.org/abs/2606.25095)
...
### [24] [Buildrix: An Open Platform for Sharing and Benchmarking Agentic AI Skills in Building Engineering](https://arxiv.org/abs/2606.25139)
...
### [25] [Active Learning for Optimal Experimental Design in Machine Learning-Based Building Energy System Identification](https://arxiv.org/abs/2606.25301)
...
### [26] [Conformal Recovery-Deadline Certificates for Runtime Assurance of Adapting Controllers](https://arxiv.org/abs/2606.25371)
*Alireza Shojaei*
...
### [27] [Control Barrier Function only Formation Tracking in Multi-Agent Systems](https://arxiv.org/abs/2606.25452)
...
### [28] [Reference-Free Heterogeneous Multi-Agent Reinforcement Learning for Grid-Friendly Tie-Line Power Shaping in Industrial Microgrids](https://arxiv.org/abs/2606.25599)
...
### [29] [Robustness and Leadership in Markov-switching Consensus Networks](https://arxiv.org/abs/2606.25888)
